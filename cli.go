...
func main() {
    ...
    app.Commands = []cli.Command{
        ...
        },
        {
            Name:   "package",
            Aliases: []string{"p"},
            Flags:   []cli.Flag{commands.SourceFlag, commands.DestinationFlag, commands.ZipFlag, commands.SignPasswordFlag,commands.AppNameFlag},
            Usage:   "Package signed app for publication to the Roku store",
            Before:  commands.EnsurePaths,
